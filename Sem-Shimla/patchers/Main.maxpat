...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 15.0, 225.0, 281.0, 22.0 ],
					"text" : "jit.gl.videoplane renderWindow @transform_reset 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 15.0, 420.0, 133.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 180.0, 45.0, 70.0, 22.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 180.0, 75.0, 35.0, 22.0 ],
					"text" : "dac~"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 156.0, 105.0, 49.0 ],
									"text" : "read glitchSprite.png, getdim"
								}
...
,
					"patching_rect" : [ 15.0, 162.0, 84.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 65.0, 160.0, 73.0, 22.0 ],
									"text" : "random 100"
								}
...
,
					"patching_rect" : [ 235.0, 162.0, 99.0, 22.0 ],
					"saved_object_attributes" : 					{
						"accentcolor" : [ 0.518893, 0.518878, 0.518887, 1.0 ],
						"bgcolor" : [ 1.0, 0.999974, 0.999991, 1.0 ],
						"color" : [ 1.0, 0.385962, 0.293389, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 235.0, 135.0, 60.0, 22.0 ],
					"text" : "r prebang"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 15.0, 195.0, 239.0, 22.0 ],
					"text" : "sh.sprite renderWindow glitchTexture 12 12"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 70.5, 105.0, 62.0, 22.0 ],
					"text" : "s prebang"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "sh.sprite.maxpat",
				"bootpath" : "~/Documents/Shimla Projects/Uncloud/2019/max-meetup-nl/Sem-Shimla/patchers",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "envelopeFollower.gendsp",
				"bootpath" : "~/Documents/Shimla Projects/Uncloud/2019/max-meetup-nl/Sem-Shimla/code",
